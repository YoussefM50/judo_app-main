...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "screen4subtitle1": MessageLookupByLibrary.simpleMessage(
            "How to wear judo pants \'customer\':-"),
        "screen4subtitle2": MessageLookupByLibrary.simpleMessage(
            "How to wear the \'Bawaji\' jacket:-"),
        "screen4subtitle3":
            MessageLookupByLibrary.simpleMessage("How to tie an obi belt:"),
        "screen4subtitle4":
            MessageLookupByLibrary.simpleMessage("How to apply a judo suit:-"),
        "screen4subtitle5":
            MessageLookupByLibrary.simpleMessage("How to apply a judo suit:-"),
        "screen4title":
            MessageLookupByLibrary.simpleMessage("How to wear a judo suit:"),
        "screen4topic1": MessageLookupByLibrary.simpleMessage(
            "• The two pants\' ties are pulled from the back as shown in the figure."),
        "screen4topic10": MessageLookupByLibrary.simpleMessage(
            "Then we wrap the suit by rotating as follows:-"),
        "screen4topic11": MessageLookupByLibrary.simpleMessage(
            "• Then we place the left end over the right end of the belt and wrap it, then insert it between the right end and tighten it so that it becomes as in the figure: - Then we tie the belt as follows: -"),
        "screen4topic12": MessageLookupByLibrary.simpleMessage(
            "The player is not allowed to wear any clothes under the judo jacket, and only girls wear a white T-shirt under the yogi."),
        "screen4topic2": MessageLookupByLibrary.simpleMessage(
            "• The drawstring of the trousers is tightened and the drawstring is inserted into the buttonhole as shown in the figure:-"),
        "screen4topic3": MessageLookupByLibrary.simpleMessage(
            "• The two laces are tied together in the front as shown in the figure:-"),
        "screen4topic4": MessageLookupByLibrary.simpleMessage(
            "• The right end of the jacket is placed on it, then the left end of the jacket is placed on it so that the mark of making the suit appears from the bottom of the jacket, as shown in the figure: -"),
        "screen4topic5": MessageLookupByLibrary.simpleMessage(
            "• The middle of the belt is placed on the abdomen, approximately at the navel, from the front, as shown in the figure:-"),
        "screen4topic6": MessageLookupByLibrary.simpleMessage(
            "• Wrap the belt around the middle from the back and then to the front as follows:-"),
        "screen4topic7": MessageLookupByLibrary.simpleMessage(
            "• Then we place the left end of the belt on the right end and insert it from the bottom of the two turns of the belt from the front, so that the left end becomes higher and the right end becomes lower, as in the figure: -"),
        "screen4topic8": MessageLookupByLibrary.simpleMessage(
            "• Then we place the left end over the right end of the belt and twist it, then insert it between the right end and tighten it so that it becomes as in the figure:-"),
        "screen4topic9": MessageLookupByLibrary.simpleMessage(
            "The suit is applied as follows:-"),
        "screen5subtitle1": MessageLookupByLibrary.simpleMessage(
            "Models of warm-up exercises used in judo:"),
        "screen5subtitle2":
            MessageLookupByLibrary.simpleMessage("Leg exercises: "),
        "screen5subtitle3": MessageLookupByLibrary.simpleMessage(
            "Samples of warm-up exercises performed by more than one player:"),
        "screen5subtitle4":
            MessageLookupByLibrary.simpleMessage("Normal warm-up exercises:"),
        "screen5title": MessageLookupByLibrary.simpleMessage(
            "Why is warming up important for judo players:-"),
        "screen5topic1": MessageLookupByLibrary.simpleMessage(
            "1 - Neck exercises: bending the neck from right to left or vice versa or backwards and rotating the head from right to left. \n 2 - Arm exercises: swinging the arms forward, down and to the side, placing the palms in front of the chest and pressing the elbows to the side, and movements A circle with the arms by raising them to the side.\n 3 - Torso exercises: standing with the arms high and pressing the torso and arms behind. The training is repeated in a sitting position, standing with the arm in front and pressing the torso to the sides, and alternating by pressing the torso forward and to the ear by trying to touch the ground with the forehead.\n"),
        "screen5topic2": MessageLookupByLibrary.simpleMessage(
            "Standing with the arms to the side and returning the legs to the side. Standing with the arms in front and returning the legs high in front, taking turns trying to touch the hands while taking into account the progression in training. Sitting and extending the legs forward and raising the knee high to touch the chest with the help of the hands. Standing and bending the knees completely and then extending them."),
        "screen5topic3": MessageLookupByLibrary.simpleMessage(
            "1. Neck exercises: Each player tries to grab the other player\'s neck with one hand. \n 2. Arm exercises: The two players stand face to face with their hands clasped in front of the chest, and the exercise is performed by bending and extending the arms. \n 3. Torso exercises: standing Two players with their arms high and their backs to each other, with an appropriate distance between them. The exercise is performed by bending the torso forward and down while trying to interlock the hands to increase the pressure of the torso backwards. The two players stand face to face with one’s arm interlocking with the other’s arm, and raising the other arm high. The exercise is performed by pulling each of them The other with the upper arm thrown back.\n 4. Exercises for the legs: Two players stand face to face and each one holds the other’s leg with his hand and the exercise is performed with the stone on one leg. Two players also stand with their backs to each other, with the arms raised in front of them and the training is performed by bending one knee Completely and extend the other leg.\n"),
        "screen5topic4": MessageLookupByLibrary.simpleMessage(
            "1-Walking on the balls of the foot.\n 2-Walking on the heel of the foot.\n 3-Walking on the outer side of the foot, then the inner.\n 4-Walking with the knees slightly bent.\n 5-Walking with long steps. 6- Walking while trying to touch the chest with the knee. 7- Walking in quick steps with circular movements of the arms. 8- Walking with the torso bent forward and down and touching the ground with the hands. Walking on one leg while holding the joint of the other foot with one hand, then switching 9-Running with the knees bent. 10-Jumping forward and then backward. 11-Jumping on one leg for a certain distance and then switching to jumping on the other. 12-Running in the opposite direction. 13-Running then Sit or lie down, then run again at the coach’s signal.\n 14- Running while performing some deception and camouflage movements.\n 15- Fast running and then standing immediately at the coach’s signal.\n 16- Fast running while changing direction when hearing the coach’s signal. \n 17- Running fast, then jumping on the stomach at the coach’s signal.\n 18- Running, then jumping with one foot and jumping with both feet.\n 19- Running forward, then jumping high, and squatting when hearing the coach’s signal.\n 20- Running forward, then jumping High up and squat down when you hear the coach\'s signal. \n"),
        "screen6title": MessageLookupByLibrary.simpleMessage(
            "Some throwing skills from above in judo:-"),
        "screen6type1": MessageLookupByLibrary.simpleMessage("di ashi bray"),
        "screen6type10": MessageLookupByLibrary.simpleMessage("Ko-achi-jari"),
        "screen6type11": MessageLookupByLibrary.simpleMessage("Kochi Guruma"),
        "screen6type12":
            MessageLookupByLibrary.simpleMessage("Tsuri kumi joshi"),
        "screen6type13":
            MessageLookupByLibrary.simpleMessage("Okoriya ashy harae"),
        "screen6type14": MessageLookupByLibrary.simpleMessage("Tai Otoshi"),
        "screen6type15": MessageLookupByLibrary.simpleMessage("Hrai Joshi"),
        "screen6type16": MessageLookupByLibrary.simpleMessage("Uchi mata"),
        "screen6type17": MessageLookupByLibrary.simpleMessage("Kusuto Jackie"),
        "screen6type18": MessageLookupByLibrary.simpleMessage("Tsuri Joshi"),
        "screen6type19": MessageLookupByLibrary.simpleMessage("Yoko Otoshi"),
        "screen6type2": MessageLookupByLibrary.simpleMessage("Haiza Guruma"),
        "screen6type20": MessageLookupByLibrary.simpleMessage("Ashi Guruma"),
        "screen6type21": MessageLookupByLibrary.simpleMessage("Hani Joshi"),
        "screen6type22":
            MessageLookupByLibrary.simpleMessage("Hirai Tsurikumi Ashi"),
        "screen6type23": MessageLookupByLibrary.simpleMessage("Tommy Nagy"),
        "screen6type24": MessageLookupByLibrary.simpleMessage("Kata Guruma"),
        "screen6type25": MessageLookupByLibrary.simpleMessage("Sumi Gachi"),
        "screen6type26": MessageLookupByLibrary.simpleMessage("Tani Otoshi"),
        "screen6type27": MessageLookupByLibrary.simpleMessage("Hani Maki Kumi"),
        "screen6type28": MessageLookupByLibrary.simpleMessage("Sukui Nagi"),
        "screen6type29": MessageLookupByLibrary.simpleMessage("Tsuri Joshi"),
        "screen6type3":
            MessageLookupByLibrary.simpleMessage("Sasai Tsurikumi Ashi"),
        "screen6type30": MessageLookupByLibrary.simpleMessage("Oh Groma"),
        "screen6type31": MessageLookupByLibrary.simpleMessage("Soto Makikomi"),
        "screen6type32": MessageLookupByLibrary.simpleMessage("Okay Otoshi"),
        "screen6type33": MessageLookupByLibrary.simpleMessage("Osuter Guruma"),
        "screen6type34": MessageLookupByLibrary.simpleMessage("Oki waza"),
        "screen6type35": MessageLookupByLibrary.simpleMessage("Yo Wakari"),
        "screen6type36": MessageLookupByLibrary.simpleMessage("Yoko Guruma"),
        "screen6type37": MessageLookupByLibrary.simpleMessage("Oshiro Joshi"),
        "screen6type38": MessageLookupByLibrary.simpleMessage("Ura Neji"),
        "screen6type39": MessageLookupByLibrary.simpleMessage("Sumi Otoshi"),
        "screen6type4": MessageLookupByLibrary.simpleMessage("Ok Joshi"),
        "screen6type40": MessageLookupByLibrary.simpleMessage("Yoko Jackie"),
        "screen6type41": MessageLookupByLibrary.simpleMessage("Marute Sionagi"),
        "screen6type42": MessageLookupByLibrary.simpleMessage("Marwateh gari"),
        "screen6type43": MessageLookupByLibrary.simpleMessage("yamarashi"),
        "screen6type44": MessageLookupByLibrary.simpleMessage("Usto Otoshi"),
        "screen6type45": MessageLookupByLibrary.simpleMessage("tasamaba jishi"),
        "screen6type46":
            MessageLookupByLibrary.simpleMessage("Hani Joshi Jayshi"),
        "screen6type5": MessageLookupByLibrary.simpleMessage("Usutu jari"),
        "screen6type6": MessageLookupByLibrary.simpleMessage("Oh Joshy"),
        "screen6type7": MessageLookupByLibrary.simpleMessage("aw atshi jari"),
        "screen6type8": MessageLookupByLibrary.simpleMessage("Ippon Seo Nagi"),
        "screen6type9": MessageLookupByLibrary.simpleMessage("Kosuto jari"),
        "screen7arabicterm1":
            MessageLookupByLibrary.simpleMessage("judo player"),
        "screen7arabicterm10": MessageLookupByLibrary.simpleMessage("foot"),
        "screen7arabicterm11":
            MessageLookupByLibrary.simpleMessage("Teacher/Coach"),
        "screen7arabicterm12":
            MessageLookupByLibrary.simpleMessage("Salute from standing"),
        "screen7arabicterm13":
            MessageLookupByLibrary.simpleMessage("Greetings from below"),
        "screen7arabicterm14":
            MessageLookupByLibrary.simpleMessage("Natural stance"),
        "screen7arabicterm15":
            MessageLookupByLibrary.simpleMessage("Natural right stance"),
        "screen7arabicterm16":
            MessageLookupByLibrary.simpleMessage("Natural Pause North"),
        "screen7arabicterm17":
            MessageLookupByLibrary.simpleMessage("defensive stance"),
        "screen7arabicterm18":
            MessageLookupByLibrary.simpleMessage("Defensive stance right"),
        "screen7arabicterm19":
            MessageLookupByLibrary.simpleMessage("Defensive position north"),
        "screen7arabicterm2": MessageLookupByLibrary.simpleMessage("Jacket"),
        "screen7arabicterm20":
            MessageLookupByLibrary.simpleMessage("suit grip"),
        "screen7arabicterm21":
            MessageLookupByLibrary.simpleMessage("Move on the mat"),
        "screen7arabicterm22":
            MessageLookupByLibrary.simpleMessage("imbalance"),
        "screen7arabicterm23": MessageLookupByLibrary.simpleMessage("Hiccups"),
        "screen7arabicterm24":
            MessageLookupByLibrary.simpleMessage("side fall"),
        "screen7arabicterm25":
            MessageLookupByLibrary.simpleMessage("Back drop"),
        "screen7arabicterm26":
            MessageLookupByLibrary.simpleMessage("Circular frontal fall"),
        "screen7arabicterm27":
            MessageLookupByLibrary.simpleMessage("Front fall"),
        "screen7arabicterm28":
            MessageLookupByLibrary.simpleMessage("North side fall"),
        "screen7arabicterm29":
            MessageLookupByLibrary.simpleMessage("Side fall to the right"),
        "screen7arabicterm3": MessageLookupByLibrary.simpleMessage("Belt"),
        "screen7arabicterm30": MessageLookupByLibrary.simpleMessage("referee"),
        "screen7arabicterm4": MessageLookupByLibrary.simpleMessage("pants"),
        "screen7arabicterm5": MessageLookupByLibrary.simpleMessage("Judo suit"),
        "screen7arabicterm6": MessageLookupByLibrary.simpleMessage("Judo hall"),
        "screen7arabicterm7": MessageLookupByLibrary.simpleMessage("rug"),
        "screen7arabicterm8": MessageLookupByLibrary.simpleMessage("hand"),
        "screen7arabicterm9":
            MessageLookupByLibrary.simpleMessage("middle/seat"),
        "screen7japaneseterm1": MessageLookupByLibrary.simpleMessage("Judoka"),
        "screen7japaneseterm10": MessageLookupByLibrary.simpleMessage("ashy"),
        "screen7japaneseterm11": MessageLookupByLibrary.simpleMessage("Sensai"),
        "screen7japaneseterm12": MessageLookupByLibrary.simpleMessage("Rayya"),
        "screen7japaneseterm13":
            MessageLookupByLibrary.simpleMessage("The Rayya"),
        "screen7japaneseterm14":
            MessageLookupByLibrary.simpleMessage("Shizen Tai"),
        "screen7japaneseterm15":
            MessageLookupByLibrary.simpleMessage("Meiji Shizen Tai"),
        "screen7japaneseterm16":
            MessageLookupByLibrary.simpleMessage("Hidari Shizen Tai"),
        "screen7japaneseterm17":
            MessageLookupByLibrary.simpleMessage("Jigutai"),
        "screen7japaneseterm18":
            MessageLookupByLibrary.simpleMessage("Meiji Jigutai"),
        "screen7japaneseterm19":
            MessageLookupByLibrary.simpleMessage("Hydari Jigutai"),
        "screen7japaneseterm2": MessageLookupByLibrary.simpleMessage("yuaji"),
        "screen7japaneseterm20":
            MessageLookupByLibrary.simpleMessage("Komi kata"),
        "screen7japaneseterm21":
            MessageLookupByLibrary.simpleMessage("tay sbaki"),
        "screen7japaneseterm22":
            MessageLookupByLibrary.simpleMessage("Kuzushi"),
        "screen7japaneseterm23": MessageLookupByLibrary.simpleMessage("Okimi"),
        "screen7japaneseterm24":
            MessageLookupByLibrary.simpleMessage("Yoko Okimi"),
        "screen7japaneseterm25":
            MessageLookupByLibrary.simpleMessage("Oshiroa Okimi"),
        "screen7japaneseterm26":
            MessageLookupByLibrary.simpleMessage("Mai Mwari Okemi"),
        "screen7japaneseterm27":
            MessageLookupByLibrary.simpleMessage("Mai Okimi"),
        "screen7japaneseterm28":
            MessageLookupByLibrary.simpleMessage("Hidari Yuko Okimi"),
        "screen7japaneseterm29":
            MessageLookupByLibrary.simpleMessage("Meiji Yuko Okimi"),
        "screen7japaneseterm3": MessageLookupByLibrary.simpleMessage("Obi"),
        "screen7japaneseterm30":
            MessageLookupByLibrary.simpleMessage("Shinban"),
        "screen7japaneseterm4": MessageLookupByLibrary.simpleMessage("zbun"),
        "screen7japaneseterm5": MessageLookupByLibrary.simpleMessage("Judogi"),
        "screen7japaneseterm6": MessageLookupByLibrary.simpleMessage("Dojo"),
        "screen7japaneseterm7": MessageLookupByLibrary.simpleMessage("Tatami"),
        "screen7japaneseterm8": MessageLookupByLibrary.simpleMessage("Ti"),
        "screen7japaneseterm9": MessageLookupByLibrary.simpleMessage("Joshi"),
        "screen7num": MessageLookupByLibrary.simpleMessage("M"),
        "screen7subtitle1":
            MessageLookupByLibrary.simpleMessage("Term in English"),
        "screen7subtitle2":
            MessageLookupByLibrary.simpleMessage("Term in Japanese"),
        "screen7subtitle3":
            MessageLookupByLibrary.simpleMessage("Illustration of the term"),
        "screen7title":
            MessageLookupByLibrary.simpleMessage("Some terms related to judo:"),
        "splashscreendialog1":
